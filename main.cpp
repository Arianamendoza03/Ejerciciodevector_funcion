...
#include <time.h>
using namespace std;
//disene la funcion que busque  un numero entero en el vector
//la funcion debe devolver verdadero si el elemento existe en el vector
//o falso en contrario
...
//diseñe la funcion que busque un numero entero en el vector
//la funcion debe devolver la posicion donde el elemneto fue encontrado
//devueelve -1 si no existe
